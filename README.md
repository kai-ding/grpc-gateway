...
[![Build Status](https://travis-ci.org/kai-ding/grpc-gateway.svg?branch=master)](https://travis-ci.org/kai-ding/grpc-gateway)
...
```sh
go get -u github.com/kai-ding/grpc-gateway/protoc-gen-grpc-gateway
go get -u github.com/kai-ding/grpc-gateway/protoc-gen-swagger
...
6. Write an entrypoint
   ...
   import (
     ...
     "github.com/kai-ding/grpc-gateway/runtime"
...
* [How gRPC error codes map to HTTP status codes in the response](https://github.com/kai-ding/grpc-gateway/blob/master/runtime/errors.go#L15)
...
# Contribution
See [CONTRIBUTING.md](http://github.com/kai-ding/grpc-gateway/blob/master/CONTRIBUTING.md).

# License
grpc-gateway is licensed under the BSD 3-Clause License.
See [LICENSE.txt](https://github.com/kai-ding/grpc-gateway/blob/master/LICENSE.txt) for more details.
