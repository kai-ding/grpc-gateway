...
gulp.task('server', shell.task([
  'go build -o bin/example-server github.com/kai-ding/grpc-gateway/examples/server/cmd/example-server',
]));

gulp.task('gateway', shell.task([
  'go build -o bin/example-gw github.com/kai-ding/grpc-gateway/examples',
]));
